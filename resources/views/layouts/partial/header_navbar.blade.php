            ...
            <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                ...
                <div data-kt-search-element="wrapper">
                    ...
                    <form data-kt-search-element="form" class="mb-3 w-100 position-relative" autocomplete="off">
                        <!--begin::Icon-->
                        <i
                            class="text-gray-500 ki-outline ki-magnifier fs-2 position-absolute top-50 translate-middle-y ms-0"></i>
                        <!--end::Icon-->
                        <!--begin::Input-->
                    ...
                    <div data-kt-search-element="results" class="d-none">
                        ...
                        <div class="scroll-y mh-200px mh-lg-350px">
                            ...
                            <!--end::Item-->
                            <!--begin::Category title-->
                            <h3 class="pt-5 pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Customers
                            </h3>
                            <!--end::Category title-->
                            <!--begin::Item-->
                            <a href="#" class="mb-5 text-gray-900 d-flex text-hover-primary align-items-center">
                            ...
                            <!--end::Item-->
                            <!--begin::Category title-->
                            <h3 class="pt-5 pb-5 m-0 fs-5 text-muted" data-kt-search-element="category-title">Projects
                            </h3>
                            <!--end::Category title-->
                            <!--begin::Item-->
                            <a href="#" class="mb-5 text-gray-900 d-flex text-hover-primary align-items-center">
                    ...
                    <div class="mb-5" data-kt-search-element="main">
                        ...
                        <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">BoomApp
                                        by Keenthemes</a>
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">"Kept
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">"KPI
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">Project
                                        Reference FAQ</a>
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">"FitPro
                                        App Development</a>
                                    <span class="fs-7 text-muted fw-semibold">#84250</span>
                                </div>
                                <!--end::Title-->
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">Shopix
                                        Mobile App</a>
                            ...
                            <div class="mb-5 d-flex align-items-center">
                                ...
                                <!--begin::Title-->
                                <div class="d-flex flex-column">
                                    <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-semibold">"Landing
                                        UI Design" Launch</a>
                    ...
                    <div data-kt-search-element="empty" class="text-center d-none">
                        ...
                        <div class="pt-10 pb-10">
                            <i class="opacity-50 ki-outline ki-search-list fs-4x"></i>
                        </div>
                        <!--end::Icon-->
                        <!--begin::Message-->
                ...
                <div class="py-5 card-body">
                    ...
                    <div class="mh-450px scroll-y me-n5 pe-5">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/amazon.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/atica.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/codeigniter.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/bootstrap-4.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/disqus.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/figma-1.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/github.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/gitlab.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
                            ...
                            <div class="col-4">
                                <a href="#"
                                    class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                    <img src="assets/media/svg/brand-logos/pinterest-p.svg" class="mb-2 w-25px h-25px"
                                        alt="" />
