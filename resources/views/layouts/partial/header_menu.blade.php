<div class="px-2 my-5 menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold px-lg-0"
    ...
    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
        ...
        <div class="p-0 menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-850px">
            ...
            <div class="overflow-hidden menu-state-bg menu-extended overflow-lg-visible" data-kt-menu-dismiss="true">
                <!--begin:Row-->
                <div class="row">
                    <!--begin:Col-->
                    <div class="px-3 py-3 mb-3 col-lg-8 mb-lg-0 py-lg-6 px-lg-6">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <div class="p-0 m-0 menu-item">
                                    ...
                                    <a href="dashboards/marketing.html" class="menu-link">
                                        <span
                                            class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                            <i class="text-gray-900 ki-outline ki-chart-simple fs-1"></i>
                                        </span>
                                        <span class="d-flex flex-column">
                        ...
                        <div class="flex-wrap gap-2 mx-5 d-flex flex-stack flex-lg-nowrap">
                            <div class="d-flex flex-column me-5">
                                <div class="text-gray-800 fs-6 fw-bold">Landing Page
                                    Template</div>
                ...
                <div class="overflow-auto d-flex w-100">
                    <ul class="p-0 nav nav-stretch nav-line-tabs fw-bold fs-6 p-lg-10 flex-nowrap flex-grow-1">
                        ...
                        <li class="nav-item mx-lg-1">
                            <a class="py-3 nav-link py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab"
                                data-bs-target="#kt_app_header_menu_pages_pages">General</a>
                        </li>
                        <!--end:Nav item-->
                        <!--begin:Nav item-->
                        <li class="nav-item mx-lg-1">
                            <a class="py-3 nav-link py-lg-6 text-active-primary" href="#" data-bs-toggle="tab"
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">
                                                Corporate</h4>
                                            <!--end:Menu heading-->
                                            <!--begin:Menu item-->
                                            <div class="p-0 m-0 menu-item">
                                    ...
                                    <div class="mb-6 col-lg-3 mb-lg-0">
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">FAQ
                                            </h4>
                                            <!--end:Menu heading-->
                                            <!--begin:Menu item-->
                                            <div class="p-0 m-0 menu-item">
                                        ...
                                        <div class="mb-6">
                                            <!--begin:Menu heading-->
                                            <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Blog
                                            </h4>
                                            <!--end:Menu heading-->
                                            <!--begin:Menu item-->
                                            <div class="p-0 m-0 menu-item">
                    ...
                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_authentication">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-6 col-lg-3 mb-lg-0">
                                ...
                                <div class="mb-6">
                                    <!--begin:Menu heading-->
                                    <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Fancy Layout
                                    </h4>
                                    <!--end:Menu heading-->
                                    <!--begin:Menu item-->
                                    <div class="p-0 m-0 menu-item">
    ...
    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
        ...
        <!--end:Menu link-->
        <!--begin:Menu sub-->
        <div class="p-0 menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-900px w-xxl-950px">
            <!--begin:Dashboards menu-->
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-4">
                                <!--begin:Heading-->
                                <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">
                                    Layouts</h4>
                                <!--end:Heading-->
                                <!--begin:Menu item-->
                                <div class="p-0 m-0 menu-item">
